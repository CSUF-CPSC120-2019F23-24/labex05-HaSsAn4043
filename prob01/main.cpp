...
int main()
{
  ...
  std::cout << "\nThe float became zero because there's not enough bits to show the very small number" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nMaximum for float was reached so it shows infinity" << std::endl;
